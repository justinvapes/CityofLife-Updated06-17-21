...
Config.NPC	          = {
    ...
    {   x =2342.6, y = 3142.3,z = 47.2, h = 185.76, npc = -1932625649}, 
}
...
Config.Zones = {
    ...
    [4] = {coords = vector3(2342.6, 3142.3, 47.2), name = _U('map_blip_shop4'), color = 56, sprite = 480, radius = 25.0, Pos = { x = 2341.1, y = 3126.2, z = 48.2}, Size  = { x = 3.0, y = 3.0, z = 1.0 }, opentext  ='Press ~g~[E]~g~ ~w~ to sell to Derek', closedtext = '~g~Derek busy hitting on your mom come back later'},
}

Config.Items = {
    { name = 'iron', price = 50, storenumber = 2},
    { name = 'gold_bar', price = 100, storenumber = 2},
    { name = 'rolex', price = 202, storenumber = 1},
    { name = 'necklace', price = 110, storenumber = 3},
    { name = 'dia_box', price = 330, storenumber = 2},
    { name = 'diamond', price = 82, storenumber = 2},
    { name = 'bottle', price = 112, storenumber = 2},
    { name = 'wedding_ring', price = 200, storenumber = 3},
    { name = 'earrings', price = 100, storenumber = 3},
    { name = 'phone', price = 150, storenumber = 1},
    { name = 'scrap_metal', price = 13, storenumber = 4},
    { name = 'plastic_parts', price = 9, storenumber = 4},
    { name = 'il_salvage', price = 88, storenumber = 4},
    { name = 'salvage', price = 19, storenumber = 4},
    { name = 'petrol', price = 9, storenumber = 4},
    { name = 'fabric', price = 3, storenumber = 4},
}