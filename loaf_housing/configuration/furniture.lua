Furniture = { 
    ...
    ['chair'] = {
        ...
        {'Chair 26', 'v_corp_bk_chair1', 150},
		{'Chair 27', 'v_corp_bk_chair2', 150},
		{'Chair 28', 'v_corp_lazychair', 150},
		{'Chair 29', 'v_corp_offchairfd', 150},
		{'Chair 30', 'v_corp_sidechair', 150},
		{'Chair 31', 'v_ind_ss_chair01', 150},
		{'Chair 32', 'v_ind_ss_chair2', 150},
		{'Chair 33', 'v_ind_ss_chair3_cso', 150},
		{'Chair 34', 'v_ilev_chair02_ped', 150},
		{'Chair 35', 'v_ilev_hd_chair', 150},
		{'Chair 36', 'v_ilev_m_dinechair', 150},
		{'Chair 37', 'v_ilev_p_easychair', 150},
		{'Chair 38', 'v_res_d_armchair', 150},
		{'Chair 39', 'v_res_d_highchair', 150},
		{'Chair 40', 'v_res_fa_chair01', 150},
		{'Chair 41', 'v_res_fh_barcchair', 150},
		{'Chair 42', 'v_res_fh_easychair', 150},
		{'Chair 43', 'v_res_j_dinechair', 150},
		{'Chair 44', 'v_res_jarmchair', 150},
		{'Chair 45', 'v_res_m_armchair', 150},		
		{'Chair 46', 'v_res_m_dinechair', 150},		
		{'Chair 47', 'v_res_mbchair', 150},		
		{'Chair 48', 'v_res_mp_stripchair', 150},		
		{'Chair 49', 'v_res_study_chair', 150},		
		{'Chair 50', 'v_res_tre_chair', 150}				
    },
    ['decorations'] = {
    ...
    ['table'] = {
        ...
        {'Table 28', 'v_corp_cd_rectable', 150},
        {'Table 29', 'v_corp_conftable', 150},
		{'Table 30', 'v_corp_conftable2', 150},	        
        {'Table 31', 'v_corp_conftable3', 150},
        {'Table 32', 'v_corp_conftable4', 150},
        {'Table 33', 'v_corp_sidetable', 150},
        {'Table 34', 'v_ind_cftable', 150},
        {'Table 35', 'v_ind_dc_table', 150},
        {'Table 36', 'v_ind_rc_lowtable', 150},
        {'Table 37', 'v_ilev_liconftable_sml', 150},		
		{'Table 38', 'v_res_d_coffeetable', 150},
	    {'Table 39', 'v_res_d_dressingtable', 150},
		{'Table 40', 'v_res_d_roundtable', 150},
		{'Table 41', 'v_res_d_smallsidetable', 150},
		{'Table 42', 'v_res_fh_coftableb', 150},		
		{'Table 43', 'v_res_fh_diningtable', 150},
		{'Table 44', 'v_res_j_coffeetable', 150},
		{'Table 45', 'v_res_j_lowtable', 150},
		{'Table 46', 'v_res_m_sidetable', 150},
		{'Table 47', 'v_res_mbbedtable', 150},
		{'Table 48', 'v_res_mdbedtable', 150},
		{'Table 49', 'v_res_tre_bedsidetable', 150},
		{'Table 50', 'v_res_tre_table2', 150},
		{'Table 51', 'v_ret_csr_table', 150},
		{'Table 52', 'v_ret_fh_dinetable', 150},
		{'Table 53', 'v_ret_fh_kitchtable', 150},
		{'Table 54', 'v_ret_ml_tablea', 150},
		{'Table 55', 'v_ret_ml_tableb', 150},
		{'Table 56', 'v_ret_ml_tablec', 150},
		{'Table 57', 'v_ret_tablesml', 150},
		{'Table 58', 'prop_tablesmall_01', 150},
		{'Table 59', 'prop_protest_table_01', 150},
		{'Table 60', 'prop_t_coffe_table', 150},
		{'Table 61', 'prop_t_coffe_table_02', 150},
		{'Table 62', 'prop_tri_table_01', 150},
		{'Table 63', 'prop_barry_table_detail', 150},
		{'Table 64', 'prop_fbi3_coffee_table', 150},
		{'Table 65', 'prop_yacht_table_02', 150},
		{'Table 66', 'prop_yacht_table_01', 150},		
		{'Table 67', 'prop_yacht_table_03', 150}
    },
    ['electronics'] = {
    ...
    ['bed'] = {
        ...
        {'Bed 5', 'v_res_mdbed', 150},
        {'Bed 6', 'v_res_mbbed', 150},
        {'Bed 7', 'v_res_d_bed', 150},
        {'Bed 8', 'v_res_tre_bed1', 150},
        {'Bed 9', 'v_res_tre_bed2', 150},
        {'Bed 10', 'v_res_tt_bed', 150},
        {'Bed 11', 'v_res_tre_bed1_messy', 150},
        {'Bed 12', 'v_med_emptybed', 150},
        {'Bed 13', 'v_8_bedrm4stuff', 150},
        {'Bed 14', 'v_med_bed2', 150},
        {'Bed 15', 'v_61_bd2_mesh_bed', 150},
        {'Bed 16', 'v_16_bdr_mesh_bed', 150},
        {'Bed 17', 'v_16_mid_bed_bed', 150},
        {'Bed 18', 'v_24_bdr_mesh_bed', 150},
        {'Bed 19', 'v_med_bed1', 150},
        {'Bed 20', 'apa_mp_h_bed_double_08', 150},
        {'Bed 21', 'apa_mp_h_bed_double_09', 150},
        {'Bed 22', 'apa_mp_h_bed_wide_05', 150},
        {'Bed 23', 'apa_mp_h_bed_with_table_02', 150},
        {'Bed 24', 'apa_mp_h_yacht_bed_01', 150},
        {'Bed 25', 'apa_mp_h_yacht_bed_02', 150},
        {'Bed 26', 'ex_prop_exec_bed_01', 150},
        {'Bed 27', 'gr_prop_gr_campbed_01', 150},
        {'Bed 28', 'hei_heist_bed_double_08', 150},
        {'Bed 29', 'sum_mp_h_yacht_bed_01', 150},
        {'Bed 30', 'v_49_motelmp_bed', 150}	
    },
    ['sofa'] = {
