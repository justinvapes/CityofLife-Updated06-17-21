...
Config.MinMoney            = 1     --  Min amount of money received from mugging
Config.MaxMoney            = 50   --  Max amount of money received from mugging.
Config.RobWaitTime         = 8     --  Current seconds it takes to finish mugging
Config.AddItemsPerctent    = 25    --  This is percent the script will add items as well as cash from mugging.
Config.AddItemsMax         = 1     --  This is the max number of items you can receive from NPC from mugging - min is 1
