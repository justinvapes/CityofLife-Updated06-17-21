...
function BlowTheTruckDoor()
	if IsVehicleStopped(ArmoredTruck) then
		...
		RequestAnimDict('anim@heists@ornate_bank@utk_thermalcharge_heels')
		while not HasAnimDictLoaded('anim@heists@ornate_bank@utk_thermalcharge_heels') do
			Citizen.Wait(50)
		end
		...
		TaskPlayAnim(playerPed, 'anim@heists@ornate_bank@utk_thermalcharge_heels', "utk_thermalcharge", 3.0, -8, -1, 63, 0, 0, 0, 0 )
