...
ss_weather_Transition = {
	...
	["OVERCAST"]   = {"CLEAR","CLOUDS","SMOG","CLEARING", "RAIN", "THUNDER"},
	["RAIN"]	   = {"CLEARING", "OVERCAST", "THUNDER"},
	["THUNDER"]    = {"OVERCAST", "RAIN"}, -- Always rotate away from Thunder, as it's annoying
