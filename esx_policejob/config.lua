...
Config.PoliceStations = { 
	...
	LSPD = {
		...
		Cloakrooms = {
			vector3(461.9423, -999.0250, -28.7)
		},

		Armories = {
			vector3(474.422, -990.714, 26.273)
		},

		Vehicles = {
			{
				Spawner = vector3(457.84,-1011.43,27.33),
				InsideShop = vector3(505.32, -999.32, 27.84),
				SpawnPoints = {
					{ coords = vector3(448.84,-1020.48,28.44), heading = 0, radius = 4.0 },
					{ coords = vector3(438.57,-1026.12,28.79), heading = 0, radius = 4.0 },
					{ coords = vector3(430.16,-1023.68,28.84), heading = 0, radius = 4.0 },
					{ coords = vector3(453.8,-1023.24,28.48), heading = 0, radius = 4.0 }
				}
			},
...
Config.AuthorizedVehicles = {
	Shared = {
		--
		--[[{ model = 'police', label = 'Police Cruiser', price = 15000 },		--
		{ model = 'police3', label = 'Police Interceptor', price = 30000 },		
		{ model = 'police4', label = 'Unmarked Cruiser', price = 15000 },		
		{ model = 'policeb', label = 'Police Bike', price = 30000 },		
		{ model = 'policet', label = 'Police Transporter', price = 100000 },		
		{ model = 'polmav', label = 'Police Helicopter', price = 500000 },		
	...
	sergeant = {
		...
		{ model = 'police4', label = 'Unmarked Cruiser', price = 15000 },		
		{ model = 'policeb', label = 'Police Bike', price = 30000 },
		{ model = 'police2', label = 'Police Buffalo', price = 40000 },
		{ model = 'fbi', label = 'Unmarked Buffalo', price = 40000 },
		{ model = 'fbi2', label = 'Unmarked Granger', price = 50000 },		
		--[[{ model = 'policet', label = 'Police Transporter', price = 100000 },		
		{ model = 'polmav', label = 'Police Helicopter', price = 500000 },		
		{ model = 'riot', label = 'Police Riot', price = 200000 },			
		{ model = 'riot2', label = 'RCV | Riot', price = 300000 },]]		
