					...
					if GetPedInVehicleSeat(car, -1) == playerPed then
						if started == true then
							if displayed == true then
								DisplayHelpText("Press ~INPUT_THROW_GRENADE~ to begin meth production")
								displayed = true
							end
						end
			...
			if progress < 96 then
				...
				if progress > 22 and progress < 24 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~A. Fix using tape')
						ESX.ShowNotification('~o~B. Leave it be ')
						ESX.ShowNotification('~o~C. Replace it')
						ESX.ShowNotification('~c~Press the letter of the option you want to do')
					end
					if selection == 1 then
						print("Selected A")
				...
				if progress > 30 and progress < 32 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~A. Open the windows to get rid of the smell')
						ESX.ShowNotification('~o~B. Leave it be')
						ESX.ShowNotification('~o~C. Put on a mask with airfilter')
						ESX.ShowNotification('~c~Press the letter of the option you want to do')
					end
					if selection == 1 then
						print("Selected A")
				...
				if progress > 38 and progress < 40 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~A. Raise the pressure')
						ESX.ShowNotification('~o~B. Raise the temperature')
						ESX.ShowNotification('~o~C. Lower the pressure')
						ESX.ShowNotification('~c~Press the letter of the option you want to do')
					end
					if selection == 1 then
						print("Selected A")
				...
				if progress > 41 and progress < 43 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~A. Do nothing')
						ESX.ShowNotification('~o~B. Try to sucking it out using syringe')
						ESX.ShowNotification('~o~C. Add more lithium to balance it out')
						ESX.ShowNotification('~c~Press the letter of the option you want to do')
					end
					if selection == 1 then
						print("Selected A")
				...
				if progress > 46 and progress < 49 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~A. Add it in')
						ESX.ShowNotification('~o~B. Put it away')
						ESX.ShowNotification('~o~C. Drink it')
						ESX.ShowNotification('~c~Press the letter of the option you want to do')
					end
					if selection == 1 then
						print("Selected A")
				...
				if progress > 55 and progress < 58 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~A. Clean it using compressed air')
						ESX.ShowNotification('~o~B. Replace the filter')
						ESX.ShowNotification('~o~C. Clean it using a tooth brush')
						ESX.ShowNotification('~c~Press the letter of the option you want to do')
					end
					if selection == 1 then
						print("Selected A")
				...
				if progress > 82 and progress < 84 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~A. Try to hold it')
						ESX.ShowNotification('~o~B. Go outside and take a shit')
						ESX.ShowNotification('~o~C. Shit inside')
						ESX.ShowNotification('~c~Press the letter of the option you want to do')
					end
					if selection == 1 then
						print("Selected A")
				...
				if progress > 88 and progress < 90 then
					...
					if selection == 0 then
						...
						ESX.ShowNotification('~o~A. Yes!')
						ESX.ShowNotification('~o~B. No')
						ESX.ShowNotification('~o~C. What if I add meth to glass instead?')
						ESX.ShowNotification('~c~Press the letter of the option you want to do')
					end
					if selection == 1 then
						print("Selected A")
	...
	while true do
		...
		if pause == true then
			if IsControlJustReleased(0, Keys['A']) then
				selection = 1
				ESX.ShowNotification('~g~Selected option A')
			end
			if IsControlJustReleased(0, Keys['B']) then
				selection = 2
				ESX.ShowNotification('~g~Selected option B')
			end
			if IsControlJustReleased(0, Keys['C']) then
				selection = 3
				ESX.ShowNotification('~g~Selected option C')
			end
		end
	end
end)