UTK = {}
UTK.timer = 40 -- countdown to secure lock in seconds (time needed to pass to door to be closed back)
UTK.hacktime = 150000 -- first door open delay to make time for police to arrive and roleplay in miliseconds (I highly recommend to leave it be (2.5 min default))
UTK.maxcash = 1500 -- maximum amount of cash a pile can hold
UTK.mincash = 800 -- minimum amount of cash a pile holds
UTK.black = true -- enable this if you want blackmoney as a reward
UTK.cooldown = 7200 -- amount of time to do the heist again in seconds (15min)
UTK.mincops = 5 -- minimum required cops to start mission
