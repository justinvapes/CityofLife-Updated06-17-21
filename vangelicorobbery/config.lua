...
Config.MinPolice                 = 3         -- Min number of police needed to rob jewelry store.
...
Config.AllowedWeapons = {
   ...
   { name = 'WEAPON_NIGHTSTICK', chance = 99 },
   { name = 'WEAPON_CROWBAR', chance = 18 },
   { name = 'WEAPON_GOLFCLUB', chance = 30 },
   { name = 'WEAPON_BAT', chance = 40 },
   { name = 'WEAPON_PUMPSHOTGUN', chance = 18 },
   { name = 'WEAPON_MUSKET', chance = 18 },
   { name = 'WEAPON_HATCHET', chance = 30 },
}
